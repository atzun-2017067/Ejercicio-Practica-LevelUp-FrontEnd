...
export const Formulario = ({ usuarioProp, titleButton, option }) => {
    ...
    const loadRoles = async () => {
        try {
            ...
            if (!roles.includes("ROL_ADMINISTRADOR")) setRoles((prev) => [...prev, "ROL_ADMINISTRADOR"]);
            if (!roles.includes("ROL_USUARIO")) setRoles((prev) => [...prev, "ROL_USUARIO"]);
            ...
            <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <select
                        ...
                        value={usuario?.rol || ""}
                        onChange={({ target: { value } }) =>
                            setUsuario((prevUsuario) => ({ ...prevUsuario, rol: value }))
                        }
                    >
